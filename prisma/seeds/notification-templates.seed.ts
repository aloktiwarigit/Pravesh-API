...
interface TemplateSeed {
  templateCode: string;
  eventType: 'service_status_change' | 'payment_confirmation' | 'document_delivered' | 'sla_alert' | 'auto_reassurance' | 'disruption_broadcast' | 'task_assignment' | 'agent_communication' | 'campaign_marketing' | 'receipt_delivery' | 'otp' | 'payment_link';
