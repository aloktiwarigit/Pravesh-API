...
async function seedServiceDefinitions(prisma, cityIdMap) {
    ...
    console.log(`Seeded ${serviceDefinitions.length} service definitions`);
}
//# sourceMappingURL=service-definitions.seed.js.map